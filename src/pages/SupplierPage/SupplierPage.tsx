...
import { selectSupplierById } from "../../features/suppliers/supplierSelectors";
import { selectPartnerById } from "../../features/partners/partnersSelectors";
type Props={
  path:string;
}
...
function SupplierPage({path}:Props) {
  ...
  // );
  // const product = useSelector((state: RootState) => selectSupplierById(state, id));
  const supplier = useSelector((state: RootState) => {
    switch (path) {
      case "suppliers":
        console.log(selectSupplierById(state, id))
        return  selectSupplierById(state, id);
      case "partners":
        return  selectPartnerById(state, id);
  ...
  return (
    <div>
      ...
      <div className={styles.container}>
        ...
        <img src={supplier.logo} alt="logo supplier" className={styles.supplier_logo} />
